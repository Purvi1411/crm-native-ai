                ...
                return (
                  <div key={msg.id} style={{ display: 'flex', justifyContent: msg.sender === 'user' ? 'flex-end' : 'flex-start', gap: 8 }}>
                    ...
                    <div style={{ maxWidth: '75%' }}>
                      <div style={{
                        background: msg.sender === 'user' ? '#06B6D4' : 'var(--bg-card)',
                          ...
                          <div style={{ marginTop: 12, borderTop: '1px solid var(--border-light)', paddingTop: 10 }}>
                            <button
                              ...
                              style={{
                                ...
                                background: '#06B6D4', color: 'var(--bg-card)', border: 'none', borderRadius: 8,
                    ...
                    {msg.sender === 'user' && (
                      <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'linear-gradient(135deg,#06B6D4,#8B5CF6)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 2 }}>
                        <IconUser />
                      </div>
                    )}
                  </div>
