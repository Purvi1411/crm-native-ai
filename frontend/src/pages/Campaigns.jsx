                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 7 }}>
                    ...
                    {camp.stats?.sent > 0 && (
                      <button
                        ...
                        style={{ background: '#FFF7ED', border: '1px solid #FED7AA', color: '#EA580C', borderRadius: 7, padding: '4px 10px', fontSize: 11, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}
                      >
                        <IconUsers /> View List
                      </button>
                    )}
