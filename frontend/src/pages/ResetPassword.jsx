        ...
        <div className="xp-card">
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 18 }}>
              ...
              <input type="password" required className="xp-inp" placeholder="Enter new password" value={password} onChange={(e) => setPassword(e.target.value)} minLength={6} />
            </div>
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: 'block', fontSize: 14, fontWeight: 600, color: isDark ? '#d1d5db' : '#374151', marginBottom: 8 }}>Confirm New Password</label>
              <input type="password" required className="xp-inp" placeholder="Confirm new password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} minLength={6} />
            </div>
